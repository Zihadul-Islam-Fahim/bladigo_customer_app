...
class _SignInViewState extends State<SignInView> {
  ...
  void initState() {
    ...
    debugPrint(
        "dail code check: ${CountryCode.fromCountryCode(Get.find<SplashController>().configModel!.country!).dialCode}");
  ...
  Widget activeCentralizeLogin(CentralizeLoginSetup centralizeLoginSetup) {
    ...
    switch (centralizeLogin) {
      case CentralizeLoginType.otp || CentralizeLoginType.otpAndSocial:
        return OtpLoginWidget(
          phoneController: _phoneController,
          phoneFocus: _phoneFocus,
          socialEnable: centralizeLogin == CentralizeLoginType.otpAndSocial
              ? true
              : false,
          oldStyleLoginPage: widget.oldStyleLoginPage,
