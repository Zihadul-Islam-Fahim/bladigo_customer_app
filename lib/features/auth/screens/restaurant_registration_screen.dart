...
class _RestaurantRegistrationScreenState
  ...
  CategoryModel? _selectedCategory; // new add
                          ...
                          child: FooterViewWidget(
                            child: SizedBox(
                              ...
                              child: ResponsiveHelper.isDesktop(context)
                                  ...
                                  : Column(children: [
                                      Visibility(
                                        visible: restaurantRegController
                                                .storeStatus ==
                                            0.1,
                                        child: Form(
                                          key: _formKeyLogin,
                                              ...
                                              children: [
                                                ...
                                                _categoryPick(
                                                  ...
                                                  onChanged: (value) {
                                                    if (value != null) {
                                                      catController
                                                          .updteResturentRegCategory(
                                                              value);
                                                      _selectedCategory = value;
                                                      debugPrint(
                                                          "Selected Category ${_selectedCategory!.id.toString()} ${_selectedCategory!.name.toString()}");
                                                    } else {
                                                      catController
                                                          .updteResturentRegCategory(
                                                              null);
                                                              ...
                                                              ? Swiper(
                                                                  ...
                                                                  viewportFraction:
                                                                      restaurantRegController.packageModel!.packages!.length >
                                                                          ...
                                                                          ? 0.7
                                                                          : 1,
                                                                  physics: restaurantRegController
                                                                              .packageModel!
                                                                              .packages!
                                                                              .length >
                                                                          1
            ...
            onPressed: (restaurantRegiController.storeStatus == 0.1 &&
                ...
                : () {
                    ...
                    if (_selectedCategory == null) {
                      showCustomSnackBar('Please Select your category');
                      return;
                    }
  ...
  Widget _categoryPick(BuildContext context, CategoryController catController,
      {required CategoryModel? selectedCat,
      required Function(CategoryModel?)? onChanged}) {
    return Obx(
      () => DropdownButton<CategoryModel?>(
        value: catController.selectedRegResturentCategory,
        onChanged: onChanged,
        isExpanded: true,
        hint: Text("Select your category"),
        items: catController.categoryList == null
            ? [
            ...
            : [
                ...
                ...catController.categoryList!.map((category) {
