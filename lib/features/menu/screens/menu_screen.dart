                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      // for test , remove in final build
                      // PortionWidget(icon: Images.cancelationIcon, title: 'New sign in screen'.tr, onTap: (){Get.to(()=>NewSignInWithOtpScreen());}, route: ''),
                      // PortionWidget(
                      //     icon: Images.cancelationIcon,
                      //     title: 'My orders '.tr,
                      //     onTap: () {
                ...
                InkWell(
                  onTap: () async {
                    if (Get.find<AuthController>().isLoggedIn()) {
                      ...
                      // await Get.to(()=> NewSignInWithOtpScreen());
                      await Get.toNamed(
